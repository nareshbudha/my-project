...
const Footer = () => {
  return (
    <div>
      <div className="bg-[#F7F7F7]  flex flex-col tablet:flex-row tablet:mt-10 ">
        <div className=" flex flex-col   w-2/6  py-10 tablet:py-2  ">
          ...
          <p className="text-[#000000]  mobile:w-80  mobile:text-sm mobile:my-8 mobile:mx-10 tablet:w-40 tablet:pr-2 tablet:text-sm tablet:font-light  tablet:ml-4  tablet:mt-2 laptop:w-80 desktop:w-96  ">
