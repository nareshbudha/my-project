...
const BulkSms = () => {
  return (
    <div className="tablet:w-11/12 laptop:w-10/12 mobile:mx-10">
      ...
      </div><div className=" bg-[#5F2466] text-[#FFFFFF] w-full flex flex-col items-center mobile:py-3 mobile:my-14">
      ...
      </div><div className="bg-[#5F2466] flex flex-col-reverse tablet:flex-row items-center mobile:py-5 mobile:my-8 mobile:px-5 tablet:px-28  tablet:py-40 tablet:w-full tablet:h-44 ">
