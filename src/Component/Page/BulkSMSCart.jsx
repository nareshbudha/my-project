      ...
      <div className="flex-1 flex-col gap-10">
        ...
        <div className="bg-[#F7F7F7]  rounded-xl my-10">
          <div className=" flex flex-col gap-1 justify-center p-2 ">
            <h1 className="text-[#5F2466] flex font-medium text-base tablet:text-xl tabletmd:text-2xl gap-1 tablet:gap-3 items-center">
              <MdTextsms />
              Bulk SMS
            </h1>
            <p className="text-[#000000] text-sm font-normal mx-4 tablet:mx-5 ">
              Plan details
            </p>
          </div>
          ...
          <div className="bg-[#FFFFFF] grid grid-cols-3  mx-5 py-3 rounded border-1 border-[#000000] ">
            <div className="flex flex-col justify-center gap-2   items-center border-r-[1px] border-[#9F9F9F] border-dashed">
              ...
              <p className="text-base tablet:text-2xl font-medium text-[#000000]">1000</p>
            </div>
            <div className="flex  flex-col  justify-center gap-2   items-center  ">
              <h1 className="text-sm selection:tablet:text-base font-normal text-[#000000]">
                Cost per SMS
              </h1>
              <p className="text-base tablet:text-2xl font-medium text-[#000000]">Rs.1</p>
            </div>
            <div className="flex flex-col justify-center gap-2   items-center border-l-[1px] border-[#9F9F9F] border-dashed">
              <h1 className="text-sm selection:tablet:text-base font-normal text-[#000000]">
                Total Cost
              </h1>
              <p className="text-base tablet:text-2xl font-medium text-[#000000]">Rs.1000</p>
            </div>
          </div>
